...
Вопросы можете обсудить между собой в Issues: https://github.com/ClusterM/vpn-how-to/issues - там уже много тем поднято.  
Если хотите сами доработать инструкцию, то можете сделать pull request.
